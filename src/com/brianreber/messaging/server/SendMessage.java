...
public class SendMessage {
	...
	public static String sendMessage(ServletContext context, String recipient, String message) {
		...
		try {
			...
			log.log(Level.INFO, "sendMessage: sender = " + sender);
			log.log(Level.INFO, "sendMessage: recipient = " + recipient);
			log.log(Level.INFO, "sendMessage: message = " + message);
			...
			log.log(Level.INFO, "sendMessage: got " + registrations.size() + " registrations");
